# PU-DR
Pytorch official code of "Optimizing Point cloud Unsampling through Downsampling Refinement:A Generative Adversarial Network Approach ". The code is modified from [PU-DR](https://github.com/6Mrzhu/PUDOS).
